...
When the project is created, simply navigate to the path `src/cpsc2150/extendedTicTacToe` in the sidebar, open the `TicTacToeGame.java` file, and hit the run icon in the top right of the screen.